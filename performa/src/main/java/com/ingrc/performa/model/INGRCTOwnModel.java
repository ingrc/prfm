...
public class INGRCTOwnModel {
	...
	public INGRCTOwnModel() {
		super();
	}

	public INGRCTOwnModel(String owner, String username) {
		super();
		this.owner = owner;
		this.username = username;
	}
	public INGRCTOwnModel(String owner, String username, String roner,
			String coner, String soner, String scner, String cdby, String cdon,
	...
	public String toString() {
		return "INGRCTOwnModel [owner=" + owner + ", username=" + username
