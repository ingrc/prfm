...
<body>
	<form action="<c:url value="/mitigationcontrol-risk/list.html" />"
		method="POST">
					...
					<div class="panel panel-default panel-no-padding">
						<div class="panel-heading">
							<h3 class="panel-title">
								<spring:message code="mitigationcontrol.risk.list.title" />
							</h3>
							<div class="panel-toolbar">
								...
								<a
									href="<c:url value="/mitigationcontrol-risk/form.html?controlId=${controlId }" />"
							...
							<div class="col-xs-12">
								...
								<table class="table table-bordered">
									<thead>
										<tr>
											<th width="10"></th>
											<th><spring:message code="mitigationcontrol.risk.list.riskid" /></th>
											<th><spring:message code="mitigationcontrol.risk.list.description" /></th>
											<th><spring:message code="mitigationcontrol.risk.list.level" /></th>
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${listModel}" var="row">
											<tr>
												<td>
													<div class="checkbox">
														<input type="checkbox" id="left-${row.riskId}"
															name="rowid"
															value="${row.riskId}">
													</div>
												</td>
