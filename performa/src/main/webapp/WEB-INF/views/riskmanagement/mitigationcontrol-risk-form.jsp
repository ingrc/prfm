				...
				<div class="panel panel-default panel-no-padding">
					<div class="panel-heading">
						<h3 class="panel-title">
							<spring:message code="mitigationcontrol.risk.form.title" />
						</h3>
						<div class="panel-toolbar">
							<a href="<c:url value="/mitigationcontrol-risk/list.html?controlId=${controlId }" />"
					...
					<div class="panel-body">
						<div class="col-xs-12">
							<c:url value="/mitigationcontrol-risk/form.html"
								var="formActionUrl" />
									...
									<div class="panel-body">
										<div class="form-group">
											<label class="col-sm-3 control-label" for="controlId"><spring:message
													code="mitigationcontrol.risk.form.controlid" /> </label>
											<div class="col-sm-9">
										...
										<div class="form-group">
											<label class="col-sm-3 control-label" for="riskid"><spring:message
													code="mitigationcontrol.risk.form.riskid" /> </label>
											<div class="col-sm-9">
												<form:select path="riskId" cssClass="form-control">
													<form:option value="${null }">
														<spring:message
															code="mitigationcontrol.risk.form.riskid.select" />
													</form:option>
													<form:options items="${riskList}" itemLabel="riskid"
														itemValue="riskid" />
												</form:select>
