				...
				<div class="panel panel-default panel-no-padding">
					<div class="panel-heading">
						<h3 class="panel-title">
							<spring:message code="menumasterleft.list.title" />
						</h3>
						<div class="panel-toolbar">
							<a href="<c:url value="/menumaster/list.html" />"
								class="btn btn-success"><i class="fa fa-chevron-left"></i> <spring:message
									code="form.back" /></a>
							<a href="<c:url value="/menumasterleft/form.html?menuMasterId=${menumaster.id }" />"
					...
					<div class="panel-body">
						<div class="col-xs-12">
							...
							<form action="<c:url value="/menumasterleft/list.html?menuMasterId=${menumaster.id}" />"
								method="POST">
									...
									<tbody>
										<c:forEach items="${list}" var="menu">
											<tr>
												...
												<td><a
													href="<c:url value="/menumasterleft/form.html?id=${menu.id}&menuMasterId=${menumaster.id}" />"
