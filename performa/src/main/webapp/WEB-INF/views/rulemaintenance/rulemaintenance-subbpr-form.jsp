				...
				<div class="panel panel-default panel-no-padding">
					<div class="panel-heading">
						...
						<div class="panel-toolbar">
							<a href="<c:url value="/rulemaintenance-subbpr/list.html" />"
					...
					<div class="panel-body">
						<div class="col-xs-12">
							<c:url value="/rulemaintenance-subbpr/form.html"
								var="formActionUrl" />
									...
									<div class="panel-body">
										<div class="form-group">
											<label class="col-sm-3 control-label" for="bprc"><spring:message
													code="rulemaintenance.subbpr.list.sbpr" /></label>
											<div class="col-sm-9">
											<c:if test="${formStat == 'update' }">
													<form:input path="sbpr" cssClass="form-control" disabled="true" />
													<form:hidden path="sbpr"/>
											</c:if>
											<c:if test="${formStat == 'addnew' }">
													<form:input path="sbpr" cssClass="form-control" />
											</c:if>
												<form:errors path="sbpr" cssClass="help-block" />
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label" for="riskid"><spring:message
													code="rulemaintenance.bpr.list.text" /> </label>
											<div class="col-sm-9">
										...
										<div class="form-group">
											<label class="col-sm-3 control-label" for="bprc"><spring:message
													code="rulemaintenance.bpr.form.title" /> </label>
											<div class="col-sm-9">
