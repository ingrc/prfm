...
<body>
	<form action="<c:url value="/rulemaintenance-bpr/list.html" />"
		method="POST">
		<div id="content">
			<div class="row">
				<div class="col-xs-12">
					<div class="panel panel-default panel-no-padding">
						<div class="panel-heading">
							<h3 class="panel-title">
								<spring:message code="rulemaintenance.bpr.list.title" />
							</h3>
							<div class="panel-toolbar">
								...
								<a
									href="<c:url value="/rulemaintenance-bpr/form.html" />"
							...
							<div class="col-xs-12">
								...
								<table class="table table-bordered">
									<thead>
										<tr>
											<th width="10"></th>
											<th><spring:message code="rulemaintenance.bpr.list.bprc" /></th>
											<th><spring:message code="rulemaintenance.bpr.list.text" /></th>
											<th></th>
									...
									<tbody>
										<c:forEach items="${listModel}" var="model">
											<tr>
												<td>
													<div class="checkbox">
														<input type="checkbox" id="left-${model.bprc}"
															name="rowid"
															value="${model.bprc}">
													</div>
												</td>
												...
												<td>${model.text }</td>
												<td align="center"><a
													href="<c:url value="/rulemaintenance-bpr/form.html?bprc=${model.bprc}" />"
