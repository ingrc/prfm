...
<body>
	<form action="<c:url value="/mitigationcontrol-owner/list.html" />"
		method="POST">
					...
					<div class="panel panel-default panel-no-padding">
						<div class="panel-heading">
							<h3 class="panel-title">
								<spring:message code="mitigationcontrol.owner.list.title" />
							</h3>
							<div class="panel-toolbar">
								...
								<a
									href="<c:url value="/mitigationcontrol-owner/form.html?controlId=${controlId }" />"
							...
							<div class="col-xs-12">
								...
								<table class="table table-bordered">
									<thead>
										<tr>
											<th width="10"></th>
											<th><spring:message code="mitigationcontrol.owner.list.owner" /></th>
											<th><spring:message code="mitigationcontrol.owner.list.username" /></th>
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${listModel}" var="row">
											<tr>
												<td>
													<div class="checkbox">
														<input type="checkbox" id="left-${row.owner}"
															name="rowid"
															value="${row.owner}">
													</div>
												</td>
