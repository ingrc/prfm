				...
				<div class="panel panel-default panel-no-padding">
					<div class="panel-heading">
						...
						<div class="panel-toolbar">
							<a href="<c:url value="/menumaster/list.html" />"
					...
					<div class="panel-body">
						<div class="col-xs-12">
							<br/>
							<c:url value="/menumaster/form.html" var="formActionUrl"/>
							<form:form method="POST" action="${formActionUrl}"
							class="form-horizontal form-bordered" commandName="modelForm">
								<form:hidden path="id"/>
								<div class="form-group">
									<label class="col-md-3 control-label" for="displayname"><spring:message code="menumaster.form.displayname"/></label>
									<div class="col-md-9">
								...
								<div class="form-group">
									<label class="col-md-3 control-label" for="url"><spring:message code="menumaster.form.url"/></label>
									<div class="col-md-9">
								...
								<div class="form-group">
									<label class="col-md-3 control-label" for="description"><spring:message code="menumaster.form.description"/></label>
									<div class="col-md-9">
								...
								<div class="form-group">
									<label class="col-md-3 control-label" for="parentId"><spring:message code="menumaster.form.parentmenu"/></label>
									<div class="col-md-9">
